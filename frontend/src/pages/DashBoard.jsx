...
const DashBoard = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6'>
        <div className='flex justify-start gap-4 max-md:flex-col'>
          {/* Total creations card */}
           <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-x1 border border-gray-200 rounded-lg'>
